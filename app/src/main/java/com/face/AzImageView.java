...
public class AzImageView extends ImageView{
	...
	protected void onDraw(Canvas canvas){
		...
		if(ifDraw) {
			...
			canvas.drawLine(rx, ry, rx+ rWidth, ry,paint);
			canvas.drawLine(rx+rWidth, ry, rx+ rWidth, ry+rHeight,paint);
			canvas.drawLine(rx+ rWidth, ry+rHeight, rx, ry+rHeight,paint);
			canvas.drawLine(rx, ry+rHeight, rx, ry,paint);
